...
const TileManager = ({
  ...
  const tiles = [
    ...
    { name: "grassMid", x: 280, sheetX: 504, sheetY: 576 }, // sign tile
    ...
    { name: "sign", x: 280, sheetX: 288, sheetY: 432, offsetY: -70 }, // welcome sign
    ...
    { name: "snowMid", x: 630, sheetX: 144, sheetY: 792, offsetY: -140 },
    { name: "snowMid", x: 700, sheetX: 144, sheetY: 792, offsetY: -140 },
    { name: "snowMid", x: 770, sheetX: 144, sheetY: 792, offsetY: -140 },
    { name: "snowMid", x: 840, sheetX: 144, sheetY: 792, offsetY: -140 },
    { name: "snowMid", x: 910, sheetX: 144, sheetY: 792, offsetY: -140 },
    { name: "snowMid", x: 980, sheetX: 144, sheetY: 792, offsetY: -140 },
    { name: "snowRight", x: 1050, sheetX: 144, sheetY: 720, offsetY: -140 },
  ];
  ...
  return (
    <>
      ...
      <Slime
        ...
        playerWidth={72}
        playerHeight={97}
        onPlayerCollision={() => console.log("Slime collided with player!")}
      />
    </>
  );
};
