...
const TileManager = ({ image, tileWidth, tileHeight, startY }) => {
	const tiles = [
		...
		{ name: "grassRight", x: 350, sheetX: 504, sheetY: 504 },
		{ name: "sign", x: 280, sheetX: 288, sheetY: 432, offsetY: -70 },

		{ name: "snowLeft", x: 420, sheetX: 144, sheetY: 864, offsetY: -140 }, // Position adjusted
	...
	return (
		<>
			...
			<Text
				...
				x={tiles[6].x + 0} // Adjust x position to center text on the sign
				y={startY + tiles[6].offsetY + 20} // Adjust y position to properly position text on the sign
